...
@section('main')
    <div class="font-[sans-serif] bg-white md:h-screen">
        <div class="grid md:grid-cols-2 items-center gap-8 h-full">
            ...
            <div class="flex items-center md:p-8 p-6 bg-[#0f3d94] h-auto lg:w-11/12 lg:ml-auto">
                <form class="max-w-lg w-full mx-auto" action="{{ url('/register') }}" method="POST">
                    @csrf
                    ...
                    <div class="flex items-center mt-8">
                        ...
                        <label htmlFor="remember-me" class="text-white ml-3 block text-sm">
                            I accept the <a href="javascript:void(0);"
                                            class="text-yellow-500 font-semibold hover:underline ml-1">Terms and
                                Conditions</a>
                        </label>
                    </div>
                    ...
                    <div class="mt-12">
                        ...
                        <p class="text-sm text-white mt-8">Already have an account? <a
